...
class VideoBackground2 extends StatefulWidget {
  const VideoBackground2({super.key});

  @override
  State<VideoBackground2> createState() => _VideoBackground2State();
}

class _VideoBackground2State extends State<VideoBackground2>
  ...
  static Future<void> _createControllers() async {
    final fwd = VideoPlayerController.asset("assets/vedio/settings.mp4");
    ...
    try {
      final rev = VideoPlayerController.asset("assets/vedio/settings.mp4");
