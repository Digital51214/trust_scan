...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  Future<void> _resetPassword() async {
    ...
    if (newPass.isEmpty || confirm.isEmpty) {
      _showMsg("Enter secure password");
      return;
    }
    if (newPass != confirm) {
      _showMsg("Passwords do not match");
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    const Text(
                      "Create a new password to restore secure access to your AI-protected account.",
                      style: TextStyle(
                        fontSize: 13.5,
                        fontWeight: FontWeight.w500,
                        color: Colors.white70,
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              "Your new password will secure access to your AI identity layer.",
                              style: TextStyle(
                                fontSize: 12,
                                fontWeight: FontWeight.w500,
